    ...
    <div className="App">
      ...
      <section id="hero" className="hero-section text-center">
        <Container>
          ...
          <Button variant="primary" size="lg" href="#contact">まずは無料で資料を見てみる</Button>
        </Container>
      </section>
      ...
      <section id="problem" className="py-6 bg-light-gray">
        <Container>
          <h2 className="text-center mb-5">貴社では、こんなお悩みありませんか？</h2>
          <Row className="justify-content-center g-4">
            <Col md={5}>
              <Card className="h-100 card-uniform-height">
                <Card.Body>
                  <Card.Title as="h4" className="fw-bold mb-3">🤔 帳票作成や手作業が多く、コア業務に集中できない</Card.Title>
            ...
            <Col md={5}>
              <Card className="h-100 card-uniform-height">
                <Card.Body>
                  <Card.Title as="h4" className="fw-bold mb-3">😩 顧客対応に追われ、品質もバラバラ</Card.Title>
            ...
            <Col md={5}>
              <Card className="h-100 card-uniform-height">
                <Card.Body>
                  <Card.Title as="h4" className="fw-bold mb-3">😥 情報がバラバラで、探すだけで一苦労</Card.Title>
            ...
            <Col md={5}>
              <Card className="h-100 card-uniform-height">
                <Card.Body>
                  <Card.Title as="h4" className="fw-bold mb-3">😟 AI導入はしたいが、何から始めれば…</Card.Title>
          ...
          <Row className="g-4">
            <Col md={4}>
              <Card className="text-center h-100 card-uniform-height">
                <Card.Body>
                  <Card.Title as="h4" className="fw-bold mb-3">介護記録・帳票作成をAIで効率化</Card.Title>
            ...
            <Col md={4}>
              <Card className="text-center h-100 card-uniform-height">
                <Card.Body>
                  <Card.Title as="h4" className="fw-bold mb-3">議事録・SNS投稿など専用ボットを構築</Card.Title>
            ...
            <Col md={4}>
              <Card className="text-center h-100 card-uniform-height">
                <Card.Body>
                  <Card.Title as="h4" className="fw-bold mb-3">最新AIモデルを自由に選択</Card.Title>
